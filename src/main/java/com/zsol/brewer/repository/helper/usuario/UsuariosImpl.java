package com.zsol.brewer.repository.helper.usuario;
...
import com.zsol.brewer.model.Grupo;
import com.zsol.brewer.model.Usuario;
import com.zsol.brewer.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries{
	...
	public Page<Usuario> filtrar(UsuarioFilter filtro, Pageable pageable) {
		...
		lista.forEach(u -> Hibernate.initialize(u.getGrupos()));
	...
	private void adicionarFiltro(UsuarioFilter filtro, Criteria criteria) {
		if(filtro != null){
			...
			if(!StringUtils.isEmpty(filtro.getEmail())){
				criteria.add(Restrictions.like("email", filtro.getEmail(), MatchMode.START));
			}
